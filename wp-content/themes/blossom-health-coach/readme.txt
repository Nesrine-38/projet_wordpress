...
Blossom Health Coach WordPress Theme, Copyright 2018 blossomthemes.com
Blossom Health Coach is distributed under the terms of the GNU GPL
...
== Changelog ==
    ...
    1.1.2 - September 09, 2022
        * Fixed: service section hover background text color

    1.1.1 - July 07, 2022
        * Added: feature to load google font locally
        
    1.1.0 - April 25, 2022
        * Fix: Wheel of Life plugin compatible fatal error fixed.
    
    1.0.9 - December 15, 2021
        * Added: Wheel of Life section and compatibility

    1.0.8 - September 22, 2021
