...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'mederma' ); ?></a>
    ...
    <!-- End-Header-Section -->
    <?php if(!(is_page_template( 'medicore-home.php' ))){ ?>
        <!-- Main-Section -->
                    ...
                    <div class="col-lg-12">
                        <div class="page-wapper-box">
                            <?php if (is_home() || is_front_page()) { ?>
                                <h3 class="hero__title"><?php echo esc_html__('blog', 'mederma') ?></h3>
                            <?php } elseif(is_search()){?>
                                <h3 class="hero__title"><?php   
                                /* translators: %s: search term */             
                                printf( esc_html__( 'Search Results for: %s', 'mederma' ), '<span>' . get_search_query() . '</span>' ); ?>
                                </h3>
                            <?php }else if(is_archive()){ ?>
                                <h3 class="hero__title"><?php the_archive_title(); ?></h3>
                            <?php }elseif(is_404()){  ?>                      
                                <h3 class="hero__title"><?php echo esc_html__('Error', 'mederma') ?></h3>
                            <?php }else{ ?>
